      ...
      <div class="col-lg-8 mx-auto">
        ...
        <div class="row">
          <div class="col-md-5 m-3 p-0 mx-auto card">
            ...
            <a href="https://ontariospca.ca/" target="_blank"><button type="button" class="btn btn-main mx-auto">Website</button></a>
          </div>
          <div class="col-md-5 m-3 p-0 mx-auto card">
            ...
            <a href="https://www.mississaugahumanesociety.ca/" target="_blank"><button type="button" class="btn btn-main mx-auto">Website</button></a>
          </div>
        </div>
